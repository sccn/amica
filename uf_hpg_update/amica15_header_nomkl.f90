...
DOUBLE PRECISION, ALLOCATABLE :: c(:,:), cx(:,:), wc(:,:), dc_numer_tmp(:,:), &
 dc_numer(:,:), dc_denom_tmp(:,:), dc_denom(:,:)
double precision, allocatable :: S(:,:), dCov(:,:), Spinv(:,:), Spinv2(:,:), &
 Stmp(:,:), Stmp2(:,:), Stmp3(:,:), dWtmp(:,:,:), ipivnx(:), ipivnw(:)
...
double precision, allocatable :: rhotmp(:,:), tmpvec(:), tmpvec2(:), tmpvec3(:), &
 tmpvec4(:), ztmp(:), utmp(:), vtmp(:)
...
DOUBLE PRECISION, ALLOCATABLE :: dbaralpha_numer_tmp(:,:,:), dbaralpha_denom_tmp(:,:,:), &
dbaralpha_numer(:,:,:), dbaralpha_denom(:,:,:)
DOUBLE PRECISION, ALLOCATABLE :: dlambda_numer_tmp(:,:,:), dlambda_denom_tmp(:,:,:), &
dlambda_numer(:,:,:), dlambda_denom(:,:,:)
DOUBLE PRECISION, ALLOCATABLE :: dkappa_numer_tmp(:,:,:), dkappa_denom_tmp(:,:,:), &
 dkappa_numer(:,:,:), dkappa_denom(:,:,:)
DOUBLE PRECISION, ALLOCATABLE :: dsigma2_numer_tmp(:,:), dsigma2_denom_tmp(:,:), &
dsigma2_numer(:,:), dsigma2_denom(:,:)
